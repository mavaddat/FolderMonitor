...
namespace FolderMonitor
{
    public partial class Service1 : ServiceBase
    {
        ...
        readonly long TIME_INTERVAL_IN_MILLISECONDS = 60 * 100;
        readonly List<RoboCopyAgent> _watchers = new List<RoboCopyAgent>();
        readonly FileOutputLogger _logger = new FileOutputLogger();
